...
Analyze growth of MercadoLibre. With over 200 million users, MercadoLibre is the most popular e-commerce site in Latin America. Analyze the company's financial and user data for ways to make the company grow. Analyze and predict search traffic and how it can translate into the ability to successfully trade the stock.
